        ...
        <div class="container-fluid p-0 m-0 primary-background banner-background" >
            ...
            <div class="jumbotron  ">
                <div class="container ">
                    ...
                    <button class="btn btn-outline-dark "> <span class="fa 	fa fa-user-plus"></span>  Start ! its Free</button>
                    <a href="login_page.jsp" class="btn btn-outline-dark "> <span class="fa fa-user-circle fa-spin"></span>  Login</a>
